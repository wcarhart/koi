...
function testfunc {
	...
	__addarg "-g" "--glag" "flag" "optional" "" "Another argument, this time a flag, with a super, super, super long description that's way longer than it should be and it just keeps going and going and going and going and when will it ever stop jesus christ"
